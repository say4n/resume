...
%-------------------------------------------------------------------------------
\section{Education}
\cusemph{Universitat Pompeu Fabra}, Barcelona, Spain \timeline{2020 - Present}\\
...
\cusemph{Mentor, Google Summer of Code}, mlpack.org \timeline{May '21 - Present}\\
Guiding mentees on multi-objective optimization methods for mlpack, a C++ ML library.\\

\vspace{-4ex}

\cusemph{Research Fellow, AI Research Institute (IIIA-CSIC)}, Barcelona \timeline{Nov '20 - Present}\\
