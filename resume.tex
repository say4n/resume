...
%-------------------------------------------------------------------------------
\section{Key\\Skills}
\cusemph{Programming}: Python, Golang, C++/C, Unix Scripting, Git, Tensorflow, Pytorch, Keras, MATLAB, Java/Kotlin (Android), Haskell, \LaTeX, Assembly (x86, MIPS), Verilog, SQL, HTML, ReactJS, Redis, Django
\\
